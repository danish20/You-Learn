...
import com.applications.arunjotsingh.youlearn.R;
...
public class NewMessageNotification {
    ...
    public static void notify(final Context context,
        ...
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.background);
